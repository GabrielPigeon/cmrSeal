...
inits <- function() {
    list(
        ...
        betaYear=rnorm(16, 0, 1.5)# 1st reference level is fixed in models, no init
...
chainOut <- nimbleMCMC(
    ...
    niter = 1*1000+2000, thin = 1,nburnin = 2000, # 1000 iterations left to estimate parameters
    WAIC=TRUE,
    summary = TRUE,
...
write_rds(chainOut,file = '202304060943_m7.rds',compress = 'xz')
