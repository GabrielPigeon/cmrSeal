...
write_rds(chainOut,file = 'cache/202304060943_m7b.rds',compress = 'xz')
...
outm7b <- read_rds("cache/202304060943_m7b.rds")
...
traceplot(m7b$samples[,c('mean.p',"mean.phi","betaSite",
                       "betaYear[4]","betaYear[12]","sd.p",
                       "bDate[6]","mu.bd","sd.bd")])
